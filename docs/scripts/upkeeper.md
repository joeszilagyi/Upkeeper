...
> Bootstrap-generated by `Upkeeper` because `/home/joe/projects/Upkeeper/main/docs/scripts/upkeeper.md` was missing.

Keep this file as the repo-local living operator guide. The wrapper only creates it when missing; it does not overwrite future edits.
...
Each invocation:
  1. Reads the latest Codex rate-limit snapshot from /home/joe/.codex/sessions.
  ...
  5. Before launching Codex, verifies that /home/joe/.codex/sessions and Codex's
...
Loop stop semantics:
  ...
  - live primary and auxiliary Codex calls also preflight the local session store;
    a read-only /home/joe/.codex/sessions is classified as a local environment
...
Important:
  ...
  - The living repo-local operator guide is:
      /home/joe/projects/Upkeeper/main/docs/scripts/upkeeper.md
  ...
  - Terminal cycle outcomes are written as cycle.summary and cycle.exit lines to:
      /home/joe/projects/Upkeeper/main/Upkeeper.log
...
Environment overrides:
  ...
  CODEX_POSTMORTEM_DIR           Default: /home/joe/projects/Upkeeper/main/runtime/journals/upkeeper-postmortems
  ...
  CODEX_LOG_FILE                Default: /home/joe/projects/Upkeeper/main/Upkeeper.log
